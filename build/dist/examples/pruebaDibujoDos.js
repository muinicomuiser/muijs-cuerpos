...
window.addEventListener("load", () => {
    ...
    let triangulo = Cuerpo.poligono(centroCanvas.x * 0.4, centroCanvas.y * 0.3, 3, 30);
    triangulo.vertices = verticesPrueba;
    let atractor = Cuerpo.circunferencia(centroCanvas.x, centroCanvas.y * 1.4, 10);
    let atractorDos = Cuerpo.circunferencia(centroCanvas.x, centroCanvas.y * 0.6, 10);
    ...
    function animar() {
        let atraccion = Vector.suma(Vector.segunPuntos(triangulo.posicion, atractor.posicion), Vector.segunPuntos(triangulo.posicion, atractorDos.posicion));
